...
//Date created: 16-Nov-2008 23:19
//Scripter: Rakesh Lad
...
Cal=new Calendar(dtToday);
	...
	winCal=window.open("","DateTimePicker","toolbar=0,status=0,menubar=0,fullscreen=no,width=200,height=250,resizable=0,top="+cnTop+",left="+cnLeft);
	RenderCal();
	winCal.focus();
}
...
//		vCalHeader+="\n<td  align='right'><a href=\"javascript:winMain.Cal.DecYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\"><</font></b></a><font face=\"Verdana\" color=\""+YrSelColor+"\" size=2><b> "+Cal.Year+" </b></font><a href=\"javascript:winMain.Cal.IncYear();winMain.RenderCal()\"><b><font color=\""+YrSelColor+"\">></font></b></a></td></tr></table></td>\n";
   ...
   //alert(Cal.Year-10);
		for (x=CurYear;x>CurYear-100;x--)
		{
			if (x==Cal.Year)
				SelectStr="Selected";
			else
				SelectStr="";
			vCalHeader+="<option "+SelectStr+" value >"+ x +"\n";
		}
...
{
var CurDateT=new Date();

		var CurYearT =CurDateT.getFullYear();
Cal.Year=CurYearT-intYear;}
